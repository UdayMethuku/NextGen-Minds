...
#Setting Fullscreen
cv.namedWindow("AI Teacher",cv.WINDOW_NORMAL)
...
#To run face expresses of student     
      ...
      cv.imshow("AI Teacher",frame)
      if cv.waitKey(1) & 0xFF == ord('q'):
       break
cam.release()           
cv.destroyAllWindows()
i want to create link
when  a user click the link the code should run and user can detect his face expersion
